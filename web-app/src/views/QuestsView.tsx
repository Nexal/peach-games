...
export function QuestsView() {
  ...
  const generateRandomTrajectory = useCallback((_centerLat: number, _centerLng: number, _radiusM: number) => {
    // Points of the quadrilateral defining the chase area
    const corners = [
