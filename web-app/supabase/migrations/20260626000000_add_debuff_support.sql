-- Add debuff support to award_clan_points + seed Klątwa Słabości shop item
...
BEGIN
  ...
  -- Sprawdź aktywną klątwę points_divider (najwyższy dzielnik, nieprzeterminowany)
...
-- Seed Klątwa Słabości into NOC KUPAŁY shop
INSERT INTO shop_items (game_id, name, description, type, icon, price, effect, duration_seconds, sort_order, is_active)
VALUES (
  'ef910ea9-4fec-4ace-9ec8-8842a5674684',
  'Klątwa Słabości',
  'Rzuć klątwę na wrogi klan — przez 15 minut wszystkie zdobywane przez niego punkty są obniżone o 20%.',
  'curse',
  '💀',
  40,
  '{"type":"points_divider","divider":1.25}',
  900,
  10,
  true
);
